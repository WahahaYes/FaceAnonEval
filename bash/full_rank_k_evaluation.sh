...
cmd1="python process_dataset.py --dataset CelebA --batch_size 16"
cmd2="python evaluate_mechanism.py --dataset CelebA --evaluation_method rank_k --rank_k_one_image_per True --batch_size 16" 

# no mechanism
$cmd2 --anonymized_dataset ../Datasets/CelebA
