...
def inference_dcos_metric_privacy(
    ...
    id_emb_scaled = id_emb_numpy + (id_emb_rotated - id_emb_numpy) / epsilon

    id_embedding = torch.tensor(id_emb_scaled, dtype=id_embedding.dtype, device=id_embedding.device)
